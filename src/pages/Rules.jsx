    ...
    return(
        ...
        <Navbar />
            ...
            <div className=" flex flex-wrap justify-center w-2/5 h-2/5 border font-bold my-10 p-4">
                 ...
                 <br />
                 <p>teda az na to ze nejsou otazky ano, ne (nechtelo se mi vymyslet vice otazek a ani s touhle strankou xd)</p>
                 <h3>Pokud AZ-kviz vubec neznas podives se na tohle uzasne video. </h3>
                 </div>
